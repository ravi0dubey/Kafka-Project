...
# File Dataset path and its column
FILE_PATH = "D:\Study\Data Science\Big Data\kafkatest\cardekho_dataset.csv"
columns=['car_name', 'brand', 'model', 'vehicle_age', 'km_driven', 'seller_type',
       'fuel_type', 'transmission_type', 'mileage', 'engine', 'max_power',
       'seats', 'selling_price']

# API Keys
API_KEY = '35D4TV4TOSSWSB24'
API_SECRET_KEY = 'OfM2yH9l/DQHUlBk0cJiMMMamTbPJ+DnR56x/JKJdMa9TzMD/bRAVz+30fc2SghC'
BOOTSTRAP_SERVER = 'pkc-921jm.us-east-2.aws.confluent.cloud:9092'
# Security protocol
SECURITY_PROTOCOL = 'SASL_SSL'
SSL_MACHENISM = 'PLAIN'
# schema registry key
SCHEMA_REGISTRY_API_KEY = 'JNOKYHPTQA6M7JEC'
SCHEMA_REGISTRY_API_SECRET = '6vbb5QK0GvkHP5GpSGIlGFc3n/2rjANvAzgYrb1XpVuBafIET+VtjhO40+KNcfrv'
#schema registry endpoint
ENDPOINT_SCHEMA_URL  = 'https://psrc-lo3do.us-east-2.aws.confluent.cloud'
